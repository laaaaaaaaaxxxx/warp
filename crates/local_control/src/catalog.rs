...
define_action_catalog! {
    ...
    tab {
        ...
        TabGroupCreate => { name: "tab.group.create", status: Implemented, target: Tab, params: Background, result: Acknowledgement },
        ...
        TabGroupNewTab => { name: "tab.group.new_tab", status: Implemented, target: Tab, params: Background, result: Acknowledgement },
        TabGroupUngroup => { name: "tab.group.ungroup", status: Implemented, target: Tab, params: None, result: Acknowledgement },
        TabGroupRemoveTab => { name: "tab.group.remove_tab", status: Implemented, target: Tab, params: None, result: Acknowledgement },
        TabGroupMoveTab => { name: "tab.group.move_tab", status: Implemented, target: Tab, params: TabGroupMove, result: Acknowledgement },
        TabGroupMove => { name: "tab.group.move", status: Implemented, target: Tab, params: Direction, result: Acknowledgement },
    }
    ...
    pane {
        ...
        PaneSplit => { name: "pane.split", status: Implemented, target: Pane, params: PaneSplit, result: Acknowledgement },
        PaneMove => { name: "pane.move", status: Implemented, target: Pane, params: PaneMove, result: Acknowledgement },
    ...
    surface {
        ...
        SurfaceRightPanelResize => { name: "surface.right_panel.resize", status: Implemented, target: Surface, params: RightPanelResize, result: Acknowledgement },
        SurfaceRightPanelInspect => { name: "surface.right_panel.inspect", status: Implemented, target: Surface, params: None, result: TargetMetadata },
